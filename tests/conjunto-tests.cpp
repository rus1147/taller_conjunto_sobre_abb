...
TEST(conjunto_test, test_insertar_cinco_valores_negativos) {
    Conjunto<int> c;
    c.insertar(-5);
    c.insertar(-4);
    c.insertar(-7);
...
TEST(conjunto_test, test_minimo_negativo) {
    Conjunto<int> c;
    c.insertar(-5);
    c.insertar(-4);
    c.insertar(-7);
    c.insertar(-6);
    c.insertar(-8);
    EXPECT_EQ(c.minimo(), -8);
}
TEST(conjunto_test, test_maximo_negativo) {
    Conjunto<int> c;
    c.insertar(-5);
    c.insertar(-4);
    c.insertar(-7);
    c.insertar(-6);
    c.insertar(-8);
    EXPECT_EQ(c.maximo(), -4);
}
TEST(conjunto_test, pertenece_val1) {
    Conjunto<int> c;
    c.insertar(5);
    c.insertar(4);
    c.insertar(7);
